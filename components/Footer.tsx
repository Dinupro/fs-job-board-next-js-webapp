        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="/resources" className="hover:text-primary transition-colors">Career Resources</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/employers/post" className="hover:text-primary transition-colors">Post a Job</Link></li>
              <li><Link href="/employers/pricing" className="hover:text-primary transition-colors">Pricing</Link></li>
              <li><Link href="/employers/resources" className="hover:text-primary transition-colors">Hiring Guides</Link></li>
            </ul>
          </div>
